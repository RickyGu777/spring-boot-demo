...
public class RecoverByPkMethod extends AbstractMethod {

    protected RecoverByPkMethod() {
        super("recoverByPk");
    }
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, "recoverByPk", sqlSource, new NoKeyGenerator(), null, null);
    }
